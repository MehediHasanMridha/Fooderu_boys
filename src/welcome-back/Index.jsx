...
import pic1 from "../assets/Rectangle 127.png";

const WelcomeBack = () => {
  return (
    <div className="2xl:max-w-[1920px] 2xl:mx-auto 2xl:flex 2xl:gap-[240px]">
      {/* Log in Part */}
      <div className="my-[72px] mx-6 flex flex-col items-center 2xl:my-[118px] 2xl:ml-[240px]">
        {/* Logo */}
        ...
        {/* First Input Field */}
        <div className="relative w-[382px] md:w-[452px] 2xl:w-[480px]">
          {/* Icon inside input */}
          <img
            src={frame1}
            alt="email Icon"
        ...
        {/* Second Input Field */}
        <div className="relative w-[382px] md:w-[452px] mt-6 2xl:w-[480px]">
          {/* Icon inside input */}
          <img
            src={frame2}
            alt="password Icon"
        ...
        {/* forgot password */}
        <div className="relative w-[334px] h-[21px] flex justify-between items-center mt-[10px] md:w-[409px] 2xl:w-[435px]">
        ...
        {/* Divider */}
        <div className="my-14 w-[388px] h-[21px] flex items-center gap-6 2xl:w-[404px]">
          {/* Line 3 (First Line) */}
