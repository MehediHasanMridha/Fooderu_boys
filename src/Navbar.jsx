...
const Navbar = () => {
  return (
    <div className="w-[430px] md:w-[771px] xl:w-[1772px] mx-auto md:px-1 md:py-2 md:relative xl:h-16">
      {/* top line  */}
      <div className="flex justify-between mt-4 ">
        ...
        <div className="flex justify-start gap-1.5 text-2xl relative xl:w-[412px] ">
          {/* search icon  */}
          <CiSearch className="xl:absolute xl:left-3 xl:top-3 " />
          <input
            ...
            placeholder="search"
          />
          <IoIosNotificationsOutline className="xl:text-[32px] text-[#161616] xl:mt-3 " />
        </div>
      </div>
