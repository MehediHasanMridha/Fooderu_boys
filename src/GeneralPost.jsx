...
// // extra start
import { FaFireFlameCurved, FaLocationDot } from "react-icons/fa6";
import image1 from "./assets/Rectangle 11.png";
import image2 from "./assets/Rectangle 130 (1).png";

// extra end

const GeneralPost = () => {
  return (
    <div className="  w-[414px] md:w-[755px] lg:w-[816px] md:mx-auto mx-auto shadow-md my-2">
      <div className="container p-2 mx-auto">
        <div className="md:w-[755px] lg:w-[816px] mx-auto md:h-[48px] my-2 gap-4 flex justify-center">
          ...
          <div className="flex justify-between gap-5">
            <div className="md:h-9 md:w-[98px] md:ml-2 lg:w-[104px] w-[70px] h-[27px]  ">
              <button className="btn bg-[#FFB800] rounded-full md:font-semibold p-[7px] text-white w-full">
                Follow
              </button>
            </div>
            <div className="flex md:ml-1 items-center my-auto justify-between gap-1 md:w-[56px] md:h-6">
              <button className="w-6 h-6 md:h-[22px] md:w-[22px]">
        ...
        <div className="w-[414px]  md:w-[755px] lg:w-[816px] lg:pr-4 mx-auto mb-2">
          <p className="md:text-[16px] text-[14px] text-[#161616]">
            Chicken biryani is a quintessential South Asian dish known for its
            rich flavors and aromatic spices. Tender pieces of chicken are
            marinated in a blend of yogurt and spices ... more
          </p>
        </div>
        ...
        <div>
          <img
            className="mx-auto w-[414px] h-[246px] md:w-[755px] lg:w-[816px] md:h-[471px]  rounded-lg  flex justify-center items-center"
            src={image1}
            alt=""
          />
          <div className="flex justify-between items-center gap-4 mt-2">
            ...
            <div className=" mt-1 flex items-center mx-auto w-[414px] h-[16px] md:w-[755px] lg:w-[816px] md:h-[22px]">
              <div className="md:w-[177px] w-[150px] flex items-center my-auto md:h-[22px]">
                <div className="">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M7.19198 2.14006C7.49065 1.42206 8.50931 1.42206 8.80798 2.14006L10.196 5.4774L13.7986 5.76673C14.5746 5.82873 14.8893 6.79673 14.298 7.3034L11.5533 9.65473L12.3913 13.1701C12.572 13.9274 11.7486 14.5254 11.0846 14.1201L7.99998 12.2361L4.91531 14.1201C4.25131 14.5254 3.42798 13.9267 3.60865 13.1701L4.44665 9.65473L1.70198 7.3034C1.11065 6.79673 1.42531 5.82873 2.20131 5.76673L5.80398 5.4774L7.19198 2.14006Z"
                      fill="url(#paint0_linear_4058_6018)"
                    />
                    <defs>
                      <linearGradient
                        id="paint0_linear_4058_6018"
                        x1="-0.434281"
                        y1="1.01775"
                        x2="16.741"
                        y2="17.426"
                ...
                <p className=" text-[12px]  font-semibold text-[#585858] flex items-center w-[126px] ml-[2px]">
              ...
              <div className="md:w-[115px] flex gap-1 items-center my-auto md:h-[22px]">
                <div className="">
                  ...
                  >
                    <path
                      ...
                      fill="url(#paint0_linear_4058_6023)"
                    />
                    <defs>
                      <linearGradient
                        id="paint0_linear_4058_6023"
                        x1="2.605"
                        y1="2.3125"
                        x2="12.0598"
                        y2="15.2945"
                ...
                <p className=" w-[78px] text-xs font-semibold text-[#585858] flex items-center justify-center">
                  14 Comments
                </p>
              </div>
              ...
              <div className="md:w-[72px] ml-1 flex gap-[3px] items-center justify-center my-auto md:h-[22px]">
                <div className="">
                  <FaLocationDot className="h-[12px] w-[13px] md:w-4 md:h-4 text-blue-600"></FaLocationDot>{" "}
                </div>
                <p className="w-[41px] text-xs font-semibold text-[#585858] flex items-center justify-center">
                  Tangail
                </p>
              </div>
            </div>
            {/* right part  */}
            <div className="md:w-[177px] w-[150px] flex items-center gap-2 my-auto md:h-[22px]">
              <FaFireFlameCurved className="text-[#EC8154] " />
              <h2 className="leading-[22px] text-[#585858] ">Trending now</h2>
            </div>
          </div>
        </div>
      </div>
