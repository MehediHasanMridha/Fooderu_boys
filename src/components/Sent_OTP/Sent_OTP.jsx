...
const Sent_OTP = () => {
    return (
        <div className="flex justify-center">
            <div className="">
                <div className="mt-[132px] w-[382px]">
                ...
                {/* dfjslfjalsjfla */}
                <div className="w-[382px] h-[220px] grid grid-cols-1 mt-[299px]">
                    <h1 className="text-18px">Let us know your phone number to provide you a better service</h1>
                    <div>
                        <input className="border-[#D2D2D2] border-2 rounded-[100px] w-[382px] h-[56px] px-4" type="text" placeholder="+880" />
                    </div>
                    <button className="rounded-[100px] w-[382px] h-[56px] bg-[#FFB800] ">Send OTP</button>
                </div>
            </div>
        </div>
    );
